class Api::V1::Accounts::ContactsController < Api::V1::Accounts::BaseController
  ...
  def index
    # Use pagination's total_count instead of separate count query for better performance
  ...
  def search
    ...
    # Use pagination's total_count instead of separate count query
  ...
  def set_include_contact_inboxes
    # Default to false for better performance - frontend already handles this correctly
