...
WEBHOOK_URL = "https://code-api.tanmaydeepsharma.com/api/approval-request"
CALLBACK_HOST = "host.docker.internal"
# Use a dynamic port based on process ID to avoid conflicts
CALLBACK_PORT = 8083 + int(os.getpid())%100
...
async def start_callback_server():
    ...
    await runner.setup()
    # FIXED: Changed from 'localhost' to '0.0.0.0' to allow Docker container access
